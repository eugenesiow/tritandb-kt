 ...
 */
 package com.tritandb.engine.experimental.lsm;
...
public final class StableGeneration {
    ...
    public static class Writer {
        ...
        public static <K,V> void write(BloomFilter.MemoryManager memoryManager, File path, final List<Generation<K,V>> generations, Serializer<K> keySerializer, final Serializer<V> valueSerializer, Comparator<K> keyComparator, StorageType storageType, CompressionCodec codec, boolean hasDeletions, long blockSize)
                throws IOException {
            write(memoryManager, path, generations, keySerializer, valueSerializer, keyComparator, storageType, codec, hasDeletions, true, blockSize);
        }

        public static <K,V> void write(BloomFilter.MemoryManager memoryManager, File path, final List<Generation<K,V>> generations, Serializer<K> keySerializer, final Serializer<V> valueSerializer, Comparator<K> keyComparator, StorageType storageType, CompressionCodec codec, boolean hasDeletions, boolean useBloomFilter, long blockSize)
                throws IOException {
...
//                ImmutableBTreeIndex.Writer.write(path, iterator, keySerializer, valueSerializer, 65536, hasDeletions);
                ImmutableBTreeIndex.Writer.write(path, iterator, keySerializer, valueSerializer, (int)blockSize, hasDeletions);
                ...
                final Iterator<Generation.Entry<K,V>> iterator = mergeIterators(generations, keyComparator);
//                final BlockCompressedRecordFile.Writer<V> writer = BlockCompressedRecordFile.Writer.open(valuesFile, valueSerializer, codec, (int)blockSize, 10, 6);
